    ...
    <div class="TableTwo">
        ...
        <div class="table-container" v-if="isEdit">
            ...
            <Row class-name="add-row-container" align="middle" justify="center" v-show="!ableAdd">
                ...
                <Col class-name="table-col" span="2">
                    <Input v-model="weightUpperModel" placeholder="上限" :maxlength="6" :number="true" title="体重上限(斤)"></Input>
                </Col>
                <Col class-name="table-col" span="2">
                    <Input v-model="weightLowerModel" placeholder="下限" :maxlength="6" :number="true" title="体重下限(斤)"></Input>
                </Col>
                <Col class-name="table-col" span="3">
                    <Input v-model="dosageUpperModel" placeholder="剂量上限" :maxlength="6" :number="true" title="推荐剂量上限"></Input>
                </Col>
                <Col class-name="table-col" span="3">
                    <Input v-model="dosageLowerModel" placeholder="剂量下限" :maxlength="6" :number="true" title="推荐剂量下限"></Input>
                </Col>
                <Col class-name="table-col" span="3">
                    <Select
                        title="剂量单位"
                        v-model="dosageUnitModel" 
                        placeholder="单位" 
                        :clearable="true">
                        <Option 
                            v-for="dosageUnitItem in dosageUnitList" 
                            :value="dosageUnitItem" 
                            :key="dosageUnitItem">
                            {{ dosageUnitItem }}
                        </Option>
                    </Select>
                    <!-- <Input v-model="dosageUnitModel" placeholder="剂量单位" :maxlength="6" title="剂量单位"></Input> -->
                </Col>
                <Col class-name="table-col" span="3">
                    <Select
                        title="用量单位"
                        v-model="useUnitModel" 
                        @on-change="useUnitChange" 
                        placeholder="单位" 
                        :clearable="true">
                        <Option 
                            v-for="useUnitItem in useUnitList" 
                            :value="useUnitItem.value" 
                            :key="useUnitItem.value">
                            {{ useUnitItem.label }}
                        </Option>
                    </Select>
                </Col>
...
export default {
    ...
    data () {
        return {
            ...
            crowdList: [],
            //体重上下限
            weightLowerModel: null,
            weightUpperModel: null,
            //推荐剂量上下限
            dosageUpperModel: null,
            dosageLowerModel: null,
            //剂量单位
            dosageUnitModel: null,
            dosageUnitList: ['g', 'mg'],
            // dosageUnitList: [
            //     {
            //         value: 'g',
    ...
    methods: {
        ...
        addItem () {
            ...
            this.crowdName = null;
            this.weightUpperModel = null;
            this.weightLowerModel = null;
            this.dosageUpperModel = null;
            this.dosageLowerModel = null;
            this.dosageUnitModel = null;
            this.useUnitModel = null;
            this.useUnitName = null;
        ...
        confirmAddItem () {
            let obj = {
                ...
                weightUpper: this.weightUpperModel,
                weightLower: this.weightLowerModel,
                dosageUpper: this.dosageUpperModel,
                dosageLower: this.dosageLowerModel,
                dosageUnit: this.dosageUnitModel,
                useUnit: this.useUnitModel,
        ...
        useUnitChange (value) {
            let _this = this;
            _this.useUnitList.forEach(function (el) {
                if (el.value === value) {
                    _this.useUnitName = el.label;
                }
            });
        },
