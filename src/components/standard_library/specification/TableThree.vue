        ...
        <div class="table-container" v-if="isEdit">
            ...
            <Row class-name="table-row" align="middle" justify="center" v-for="(item, index) in list" :key="item.usagecode">
               <Col class-name="table-col" span="4">
                ...
                <Col class-name="table-col" span="3">
                    {{ item.concentrationUpper }}
                </Col>
                <Col class-name="table-col" span="3">
                    {{ item.concentrationLower }}
                </Col>
                <Col class-name="table-col" span="4">
                    {{ item.unit }}
                </Col>
            ...
            <Row class-name="add-row-container" align="middle" justify="center" v-show="!ableAdd">
                ...
                <Col class-name="table-col" span="3">
                    <Input v-model="concentrationUpperModel" placeholder="浓度下限" :maxlength="6" :number="true" title="浓度下限(%)"></Input>
                </Col>
                <Col class-name="table-col" span="3">
                    <Input v-model="concentrationLowerModel" placeholder="浓度上限" :maxlength="6" :number="true" title="浓度上限(%)"></Input>
                </Col>
                <Col class-name="table-col" span="4">
                    <Select
                        title="浓度单位"
                    ...
                    <!-- <Input v-model="unitModel" placeholder="浓度单位" :maxlength="6" title="浓度单位"></Input> -->
                </Col>
                <Col class-name="table-col" span="4">
                   <Select
                        title="错误类型"
...
export default {
    ...
    data () {
        return {
            ...
            //浓度上下限
            concentrationUpperModel: null,
            concentrationLowerModel: null,
            //浓度单位
            unitModel: null,
            unitList: ['g/ml', 'g/l', 'mg/ml', 'mg/l'],
            //错误类型
    ...
    methods: {
        ...
        addItem () {
            ...
            this.concentrationUpperModel = null;
            this.concentrationLowerModel = null;
            this.unitModel = null;
        ...
        confirmAddItem () {
            let obj = {
                ...
                concentrationUpper: this.concentrationUpperModel,
                concentrationLower: this.concentrationLowerModel,
                unit: this.unitModel,
